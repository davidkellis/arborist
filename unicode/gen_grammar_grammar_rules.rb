...
puts "unicode_mark_spacing_combining <- #{unicode_ranges(["Mc"])}"
puts "unicode_mark_nonspacing <- #{unicode_ranges(["Mn"])}"
# puts "unicode_number_decimal_digit <- #{unicode_ranges(["Nd"])}"    # this is the same as unicode_digit above
puts "unicode_number_letter <- #{unicode_ranges(["Nl"])}"
puts "unicode_punctuation_connector <- #{unicode_ranges(["Pc"])}"
puts "unicode_separator_space <- #{unicode_ranges(["Zs"])}"
